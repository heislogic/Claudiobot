...
from config import (
    CANAL_STAFF_ID, CARGO_STAFF_ID,
    CATEGORIAS_POR_CLASSE, EMOJIS_POR_CLASSE, BUILD_LEADER_POR_CLASSE
)
...
# --- View dos botões de staff (aceitar/recusar) ---
...
# --- View com botão para abrir formulário (para o comando slash) ---
...
class FormularioCog(commands.Cog):
    ...
    @app_commands.command(name="formulario", description="Envia o formulário de recrutamento da guilda")
